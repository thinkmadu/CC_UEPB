...
UPDATE_DISPLAYS:
    ...
    SETB P3.2 ; Habilita o display esquerdo
    CLR P3.3 ; Desabilita o display direito

    ACALL DELAY

    MOV A,B ; Move o valor do display direito para A
    MOVC A,@A+DPTR ; Converte o valor do display direito
    MOV P1,A ; Atualiza o display direito
    CLR P3.2 ; Desabilita o display esquerdo
    SETB P3.3 ; Habilita o display direito
